public class PalindromeUsingReverse {
    ...
    boolean isPalindrome(Node head) {
        ...
        /*
         * In case of odd sized lists, the middle element need not to be a part of the
         * second half. So making a separate variable to store it in case of odd-sized
        ...
        if (head != null && head.next != null) {
             ...
             * for odd elements. the middle node is to be skipped for odd case and store it
             * somewhere so that the original list can be restored
             */
             ...
             * 
             * 1) Reverse the second half again. 2) If the list was odd sized, then the
             * midNode will not be Null The prev_of_slow.next will point to the midNode. The
             * secondHalf will contain the elements next to middle node 3) If the list was
             * even sized, then the midNode will be null. The prev_of_slow will point to the
             * secondHalf.
             */
